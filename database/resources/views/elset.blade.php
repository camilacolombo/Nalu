...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="main">
				<p> Aqui vamos a encontrar todas las herramientas e informacion que preciamos para estar preparados ante un viaje de Surf.</p>
				<br>
				<h1> - Spots - </h1>
				<br>
				<div class="spots">
					<div class="America">
						<div class="Argentina">
								<a href="argentina.php">Argentina</a>
							</div>
						<div class="Brasil">
							<a href="brasil.php">Brasil</a>
						</div>
						<div class="Peru">
							<a href="peru.php">Peru</a>	
						</div>
			</div>
			<h1>Herramientas</h1>
			<div class="tool">
